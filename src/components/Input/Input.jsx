...
const Input = ({ label, placeholder, value, handleChange, name, required, labelStyle, inputStyle, type = "text", disabled }) => {
    return (
        <div className="flex flex-col">
            ...
            <input disabled={disabled} name={name} type={type} value={value} onChange={handleChange} className={"border-[1px] rounded-[4px] px-[10px] py-[5px] h-[40px] mt-[5px] flex items-center " + inputStyle || ""} placeholder={placeholder} />
        </div>
    )
}
