...
<button className="hidden md:block py-[12.5px] font-semibold px-[40px] text-[0.875em] bg-transparent text-Foundation/primary/primary-1 border-Foundation/primary/primary-1 rounded-[4px] border-[1px] ">
   Register
</button>
...
Login
        ...
        </div>
        {
         ...
         <div className='flex justify-center items-center p-4 text-Small/Label/Large-Strong text-Foundation/neutral/neutral-8 gap-[15px] flex-wrap'>
             <select name="cakes" id="cakes" className='capitalize w-[fit-content] max-w-[fit-content]'>
