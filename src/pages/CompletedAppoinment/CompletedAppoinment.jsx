            ...
            <div className='container mx-auto px-3'>
                ...
                <div className='bg-[#ffff] flex p-[24px] mx-[32px] mt-[18px] gap-[740px] rounded-[10px] justify-center items-center'>
                    ...
                    <div className='flex justify-center items-center'>
                        <button className='py-[12.5px] font-semibold px-[40px] text-[0.875em] bg-linear text-[#fff] rounded-[4px]'>Details</button>
                    </div>
                </div>
...
export default CompletedAppoinment